...
export const CzNavMenuExtDropdown: React.FC = () => {
  ...
  return (
    <Menu as="div" className="czNavMenuExtDropdown">
      <div>
        <Menu.Button className="czNavMenu__menuItem dropdown-toggler">
          ...
          <Menu.Item>
            {({ active }) => (
              <Link passHref href={pathNames.product}>
                <li className={`czNavMenuExtDropdown__item ${active ? "active" : ""}`}>{fixtures.nav_menu.product}</li>
              </Link>
            )}
          </Menu.Item>
          <Menu.Item>
          ...
          <Menu.Item>
            {({ active }) => (
              <Link passHref href={pathNames.articles}>
                <li className={`czNavMenuExtDropdown__item ${active ? "active" : ""}`}>{fixtures.nav_menu.articles}</li>
              </Link>
            )}
          </Menu.Item>
        </Menu.Items>
